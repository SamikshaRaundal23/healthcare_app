...
const PatientDashboard = () => {
  ...
  const rawProfilePic = localStorage.getItem('profile_picture');
const profilePicture = rawProfilePic
  ? rawProfilePic.startsWith('/media/')
    ? `http://localhost:8000${rawProfilePic}`
    : rawProfilePic
