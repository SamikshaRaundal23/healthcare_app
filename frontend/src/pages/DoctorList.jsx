...
const DoctorList = () => {
  ...
  const { isAuthenticated, userType, accessToken, refreshToken } = authState;
  ...
  }, [isAuthenticated, userType, accessToken, refreshToken, navigate]);
            ...
            >
              <motion.img
                ...
                onError={(e) => {
                  ...
                  console.error('Image failed to load:', doctor.profile_picture);
                }}
